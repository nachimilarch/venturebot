...
CREATE TABLE `credit_requests` (
  ...
  CONSTRAINT `credit_requests_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `flow_nodes` (
  ...
  `message_type` enum('text','buttons','list','template') DEFAULT 'text',
  `buttons` json DEFAULT NULL,
  `next_trigger` varchar(100) DEFAULT NULL,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `flow_id` (`flow_id`),
  KEY `tenant_id` (`tenant_id`),
  CONSTRAINT `flow_nodes_ibfk_1` FOREIGN KEY (`flow_id`) REFERENCES `flows` (`id`) ON DELETE CASCADE,
  CONSTRAINT `flow_nodes_ibfk_2` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `flows` (
  ...
  PRIMARY KEY (`id`),
  KEY `tenant_id` (`tenant_id`),
  CONSTRAINT `flows_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tenant_flow_config`
--

DROP TABLE IF EXISTS `tenant_flow_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tenant_flow_config` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `welcome_message` text,
  `ask_name_msg` text,
  `ask_interest_msg` text,
  `ask_budget_msg` text,
  `onboarding_done_msg` text,
  `menu_header_msg` text,
  `appointment_types` json DEFAULT NULL,
  `talk_team_msg` text,
  `contact_info` varchar(255) DEFAULT NULL,
  `slot_days_ahead` tinyint DEFAULT '2',
  `slot_times` json DEFAULT NULL,
  `industry_prompt` varchar(100) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tenant_id` (`tenant_id`),
  CONSTRAINT `tenant_flow_config_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tenant_flow_config`
--

LOCK TABLES `tenant_flow_config` WRITE;
/*!40000 ALTER TABLE `tenant_flow_config` DISABLE KEYS */;
INSERT INTO `tenant_flow_config` VALUES (1,1,'? Hi! Welcome to *VWMC*.\n\nI\'m your property assistant. I can help you:\n✅ Find your dream home or investment\n✅ Schedule a site visit\n✅ Connect with our sales team\n\nTo get started, could you tell me your *full name*?',NULL,'Great to meet you, *{name}*! ?\n\nWhat type of property are you looking for?\n\n_e.g. 2BHK flat, villa, plot, commercial space_','Perfect! What is your *budget range*?\n\n_e.g. ₹40L–₹60L, ₹1Cr+, or type Skip_','✅ *Thank you, {name}!*\n\nYour requirements have been noted. Our property consultant will review them shortly.\n\nWhat would you like to do next?','{greeting}\n\nHow can I assist you today?','[{\"id\": \"type_visit\", \"title\": \"In-Person Visit\", \"description\": \"Visit our office or location\"}, {\"id\": \"type_call\", \"title\": \"Phone Call\", \"description\": \"We\'ll call you at a set time\"}, {\"id\": \"type_video\", \"title\": \"Video Call\", \"description\": \"Online meeting via Google Meet\"}]','? *Talk to Our Sales Team*\n\nA property consultant from *VWMC* will reach out to you shortly. ?\n\nFeel free to share any specific requirements and we\'ll get back to you soon!','+91-8686903927',1,'[\"02:00 PM\", \"03:00 PM\", \"04:00 PM\", \"05:00 PM\", \"06:00 PM\", \"10:00 AM\", \"12:00 PM\"]','property requirement','2026-04-19 07:54:09','2026-04-19 08:05:14');
/*!40000 ALTER TABLE `tenant_flow_config` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tenants` VALUES (1,'VWMC','REAL ESTATE',981,5,'2026-02-12 10:59:53',NULL,NULL,NULL,NULL,'971897292671577'),(2,'VS Diet Concept','NUTRITIONIST',0,0,'2026-02-24 17:35:48',NULL,NULL,NULL,NULL,NULL),(3,'Rise Up Education',NULL,499,0,'2026-04-17 10:26:06',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `users` VALUES (1,1,'VWMC','vwmc@gmail.com','$2b$10$W78CvLUW.BwMkSvASLOAseRPiholHjOlIEgi8WAs8z1Lgw4ZRIJoW','admin','active',NULL,'2026-02-23 06:25:09','2026-02-11 18:26:39',0),(2,NULL,'Milarch Tech','nachiketh.desai@milarch.in','$2b$10$DvS7yXjN7dAGiw/E0pgtUu6w.GIxqrM.ngaT4ms9hziP8Oo.Yk9CG','superadmin','active',NULL,'2026-04-19 09:01:38','2026-02-15 05:10:51',1),(3,NULL,'VS Diet Concept','nutrition@vsdiet.in','$2b$10$pV12ZycBq6QZq8Qdnd/ID.JoECNuQnnRc91xAbPEZfsb/uVNpoB/K','admin','active',NULL,'2026-02-24 17:33:19','2026-02-24 17:33:19',0),(5,3,'Rise Up Education','riseup@gmail.com','$2b$12$KJJQRvUl1kRhpaLwbAeWzulMWCjMwk3JnLIc5NpVCoF5kKHjUPyrm','admin','active',NULL,'2026-04-17 10:26:07','2026-04-17 10:26:07',0);
...
-- Dump completed on 2026-04-19 14:57:27
